...
// Example usage of Headless UI Dialog
// You may need to adjust props and structure to match your app's needs

export function AppDialog({ open, onClose, children, ...props }) {
  return (
